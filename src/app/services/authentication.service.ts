...
export class AuthenticationService {
  ...
  getResep(): Observable<any> {
    return this.postMethod({}, 'tampil.php');
  }

  addResep(namaResep: string, langkah: string): Observable<any> {
    return this.postMethod(
      { nama_resep: namaResep, langkah: langkah },
      'tambah.php'
    );
  }
  ...
  editResep(
    ...
    return this.postMethod(
      { id_resep: idResep, nama_resep: namaResep, langkah: langkah },
      'edit.php'
    );
  }

  deleteResep(idResep: number): Observable<any> {
    return this.postMethod({ id_resep: idResep }, 'hapus.php');
  }
}
